...
public final class WeightingFunction1 {
    ...
    private interface CalculateWeight {
        void calculate(WeightingFunction1 generator, int field, int color);
    }

    private final static CalculateWeight[] calculationFunctions = new CalculateWeight[Board.blackKing + 1];
    static {
        calculationFunctions[Board.whitePawn]   = WeightingFunction1::_calculateForWhitePawn;
        calculationFunctions[Board.whiteKnight] = WeightingFunction1::_calculateForKnight;
        calculationFunctions[Board.whiteBishop] = WeightingFunction1::_calculateForBishop;
        calculationFunctions[Board.whiteRook]   = WeightingFunction1::_calculateForRook;
        calculationFunctions[Board.whiteQueen]  = WeightingFunction1::_calculateForQueen;
        calculationFunctions[Board.whiteKing]   = WeightingFunction1::_calculateForKing;
        calculationFunctions[Board.blackPawn]   = WeightingFunction1::_calculateForBlackPawn;
        calculationFunctions[Board.blackKnight] = WeightingFunction1::_calculateForKnight;
        calculationFunctions[Board.blackBishop] = WeightingFunction1::_calculateForBishop;
        calculationFunctions[Board.blackRook]   = WeightingFunction1::_calculateForRook;
        calculationFunctions[Board.blackQueen]  = WeightingFunction1::_calculateForQueen;
        calculationFunctions[Board.blackKing]   = WeightingFunction1::_calculateForKing;
    }
    ...
    public static float getMaterialWeightOfMove(int move, int depth) {
        final float capturedWeight = WeightingFunction1.weightOfPiece[Move.getCapturedPiece(move)];
    ...
    public String toString() {
        return "piecesWeight:       w=" + piecesWeight[0] + ", b=" + piecesWeight[1] + ", delta=" + (piecesWeight[0] - piecesWeight[1]) + ", weight=" + (piecesWeight[0] - piecesWeight[1]) + '\n' +
               "positionWeight:     w=" + positionWeight[0] + ", b=" + positionWeight[1] + ", delta=" + (positionWeight[0] - positionWeight[1]) + ", weight=" + (positionWeight[0] - positionWeight[1]) / 100f * positionFactor + '\n' +
    ...
    private static void _calculateForWhitePawn(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForBlackPawn(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForKnight(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForBishop(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForRook(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForQueen(WeightingFunction1 generator, int field, int color) {
    ...
    private static void _calculateForKing(WeightingFunction1 generator, int field, int color) {
    ...
    private boolean move(final byte movingPiece, final int from, final int to, int color) {
        ...
        final int oppositeColor = WeightingFunction1.oppositeColor[color];
